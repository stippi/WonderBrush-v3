...
namespace agg
{
    ...
    //==== These are the original AGG blenders slightly tweaked to take
    //==== into account that alpha is not multiplied by cover.
    ...
    //==== These are the accurate blenders that use Alvy Ray Smith's 
    //==== blending algorithms.
    
    //=========================================================blender_rgba_ars
    template<class ColorT, class Order> struct blender_rgba_ars
    {
        typedef ColorT color_type;
        typedef Order order_type;
        typedef typename color_type::value_type value_type;
    ...
    //====================================================blender_rgba_pre_ars
    template<class ColorT, class Order> struct blender_rgba_pre_ars
    {
        typedef ColorT color_type;
        typedef Order order_type;
        typedef typename color_type::value_type value_type;
    ...
    //==================================================blender_rgba_plain_ars
    template<class ColorT, class Order> struct blender_rgba_plain_ars
    {
        typedef ColorT color_type;
        typedef Order order_type;
        typedef typename color_type::value_type value_type;
    ...
    //----------------------------------------------------- accurate blenders
    typedef blender_rgba_ars<rgba8, order_rgba> blender_rgba32; //----blender_rgba32
    typedef blender_rgba_ars<rgba8, order_argb> blender_argb32; //----blender_argb32
    typedef blender_rgba_ars<rgba8, order_abgr> blender_abgr32; //----blender_abgr32
    typedef blender_rgba_ars<rgba8, order_bgra> blender_bgra32; //----blender_bgra32

    typedef blender_rgba_pre_ars<rgba8, order_rgba> blender_rgba32_pre; //----blender_rgba32_pre
    typedef blender_rgba_pre_ars<rgba8, order_argb> blender_argb32_pre; //----blender_argb32_pre
    typedef blender_rgba_pre_ars<rgba8, order_abgr> blender_abgr32_pre; //----blender_abgr32_pre
    typedef blender_rgba_pre_ars<rgba8, order_bgra> blender_bgra32_pre; //----blender_bgra32_pre

    typedef blender_rgba_plain_ars<rgba8, order_rgba> blender_rgba32_plain; //----blender_rgba32_plain
    typedef blender_rgba_plain_ars<rgba8, order_argb> blender_argb32_plain; //----blender_argb32_plain
    typedef blender_rgba_plain_ars<rgba8, order_abgr> blender_abgr32_plain; //----blender_abgr32_plain
    typedef blender_rgba_plain_ars<rgba8, order_bgra> blender_bgra32_plain; //----blender_bgra32_plain

    typedef blender_rgba_ars<rgba16, order_rgba> blender_rgba64; //----blender_rgba64
    typedef blender_rgba_ars<rgba16, order_argb> blender_argb64; //----blender_argb64
    typedef blender_rgba_ars<rgba16, order_abgr> blender_abgr64; //----blender_abgr64
    typedef blender_rgba_ars<rgba16, order_bgra> blender_bgra64; //----blender_bgra64

    typedef blender_rgba_pre_ars<rgba16, order_rgba> blender_rgba64_pre; //----blender_rgba64_pre
    typedef blender_rgba_pre_ars<rgba16, order_argb> blender_argb64_pre; //----blender_argb64_pre
    typedef blender_rgba_pre_ars<rgba16, order_abgr> blender_abgr64_pre; //----blender_abgr64_pre
    typedef blender_rgba_pre_ars<rgba16, order_bgra> blender_bgra64_pre; //----blender_bgra64_pre
...
//----------------------------------------------------------- legacy blenders
    ...
    typedef blender_rgba<rgba8, order_rgba> blender_rgba32_legacy; //----blender_rgba32_legacy
    typedef blender_rgba<rgba8, order_argb> blender_argb32_legacy; //----blender_argb32_legacy
    typedef blender_rgba<rgba8, order_abgr> blender_abgr32_legacy; //----blender_abgr32_legacy
    typedef blender_rgba<rgba8, order_bgra> blender_bgra32_legacy; //----blender_bgra32_legacy

    typedef blender_rgba_pre<rgba8, order_rgba> blender_rgba32_pre_legacy; //----blender_rgba32_pre_legacy
    typedef blender_rgba_pre<rgba8, order_argb> blender_argb32_pre_legacy; //----blender_argb32_pre_legacy
    typedef blender_rgba_pre<rgba8, order_abgr> blender_abgr32_pre_legacy; //----blender_abgr32_pre_legacy
    typedef blender_rgba_pre<rgba8, order_bgra> blender_bgra32_pre_legacy; //----blender_bgra32_pre_legacy

    typedef blender_rgba_plain<rgba8, order_rgba> blender_rgba32_plain_legacy; //----blender_rgba32_plain_legacy
    typedef blender_rgba_plain<rgba8, order_argb> blender_argb32_plain_legacy; //----blender_argb32_plain_legacy
    typedef blender_rgba_plain<rgba8, order_abgr> blender_abgr32_plain_legacy; //----blender_abgr32_plain_legacy
    typedef blender_rgba_plain<rgba8, order_bgra> blender_bgra32_plain_legacy; //----blender_bgra32_plain_legacy

    typedef blender_rgba<rgba16, order_rgba> blender_rgba64_legacy; //----blender_rgba64_legacy
    typedef blender_rgba<rgba16, order_argb> blender_argb64_legacy; //----blender_argb64_legacy
    typedef blender_rgba<rgba16, order_abgr> blender_abgr64_legacy; //----blender_abgr64_legacy
    typedef blender_rgba<rgba16, order_bgra> blender_bgra64_legacy; //----blender_bgra64_legacy

    typedef blender_rgba_pre<rgba16, order_rgba> blender_rgba64_pre_legacy; //----blender_rgba64_pre_legacy
    typedef blender_rgba_pre<rgba16, order_argb> blender_argb64_pre_legacy; //----blender_argb64_pre_legacy
    typedef blender_rgba_pre<rgba16, order_abgr> blender_abgr64_pre_legacy; //----blender_abgr64_pre_legacy
    typedef blender_rgba_pre<rgba16, order_bgra> blender_bgra64_pre_legacy; //----blender_bgra64_pre_legacy


    //-------------------------------------------------------- legacy pixfmts
    typedef pixfmt_alpha_blend_rgba<blender_rgba32_legacy, rendering_buffer, pixel32_type> pixfmt_rgba32_legacy; //----pixfmt_rgba32_legacy
    typedef pixfmt_alpha_blend_rgba<blender_argb32_legacy, rendering_buffer, pixel32_type> pixfmt_argb32_legacy; //----pixfmt_argb32_legacy
    typedef pixfmt_alpha_blend_rgba<blender_abgr32_legacy, rendering_buffer, pixel32_type> pixfmt_abgr32_legacy; //----pixfmt_abgr32_legacy
    typedef pixfmt_alpha_blend_rgba<blender_bgra32_legacy, rendering_buffer, pixel32_type> pixfmt_bgra32_legacy; //----pixfmt_bgra32_legacy

    typedef pixfmt_alpha_blend_rgba<blender_rgba32_pre_legacy, rendering_buffer, pixel32_type> pixfmt_rgba32_pre_legacy; //----pixfmt_rgba32_pre_legacy
    typedef pixfmt_alpha_blend_rgba<blender_argb32_pre_legacy, rendering_buffer, pixel32_type> pixfmt_argb32_pre_legacy; //----pixfmt_argb32_pre_legacy
    typedef pixfmt_alpha_blend_rgba<blender_abgr32_pre_legacy, rendering_buffer, pixel32_type> pixfmt_abgr32_pre_legacy; //----pixfmt_abgr32_pre_legacy
    typedef pixfmt_alpha_blend_rgba<blender_bgra32_pre_legacy, rendering_buffer, pixel32_type> pixfmt_bgra32_pre_legacy; //----pixfmt_bgra32_pre_legacy

    typedef pixfmt_alpha_blend_rgba<blender_rgba32_plain_legacy, rendering_buffer, pixel32_type> pixfmt_rgba32_plain_legacy; //----pixfmt_rgba32_plain_legacy
    typedef pixfmt_alpha_blend_rgba<blender_argb32_plain_legacy, rendering_buffer, pixel32_type> pixfmt_argb32_plain_legacy; //----pixfmt_argb32_plain_legacy
    typedef pixfmt_alpha_blend_rgba<blender_abgr32_plain_legacy, rendering_buffer, pixel32_type> pixfmt_abgr32_plain_legacy; //----pixfmt_abgr32_plain_legacy
    typedef pixfmt_alpha_blend_rgba<blender_bgra32_plain_legacy, rendering_buffer, pixel32_type> pixfmt_bgra32_plain_legacy; //----pixfmt_bgra32_plain_legacy

    typedef pixfmt_alpha_blend_rgba<blender_rgba64_legacy, rendering_buffer, pixel64_type> pixfmt_rgba64_legacy; //----pixfmt_rgba64_legacy
    typedef pixfmt_alpha_blend_rgba<blender_argb64_legacy, rendering_buffer, pixel64_type> pixfmt_argb64_legacy; //----pixfmt_argb64_legacy
    typedef pixfmt_alpha_blend_rgba<blender_abgr64_legacy, rendering_buffer, pixel64_type> pixfmt_abgr64_legacy; //----pixfmt_abgr64_legacy
    typedef pixfmt_alpha_blend_rgba<blender_bgra64_legacy, rendering_buffer, pixel64_type> pixfmt_bgra64_legacy; //----pixfmt_bgra64_legacy

    typedef pixfmt_alpha_blend_rgba<blender_rgba64_pre_legacy, rendering_buffer, pixel64_type> pixfmt_rgba64_pre_legacy; //----pixfmt_rgba64_pre_legacy
    typedef pixfmt_alpha_blend_rgba<blender_argb64_pre_legacy, rendering_buffer, pixel64_type> pixfmt_argb64_pre_legacy; //----pixfmt_argb64_pre_legacy
    typedef pixfmt_alpha_blend_rgba<blender_abgr64_pre_legacy, rendering_buffer, pixel64_type> pixfmt_abgr64_pre_legacy; //----pixfmt_abgr64_pre_legacy
    typedef pixfmt_alpha_blend_rgba<blender_bgra64_pre_legacy, rendering_buffer, pixel64_type> pixfmt_bgra64_pre_legacy; //----pixfmt_bgra64_pre_legacy
}
