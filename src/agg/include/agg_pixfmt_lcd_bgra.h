...
#ifndef AGG_PIXFMT_LCD_BGRA_INCLUDED
#define AGG_PIXFMT_LCD_BGRA_INCLUDED
...
namespace agg
{
	...
	public:
		...
		pixfmt_lcd_bgra(rendering_buffer& buffer,
			...
			const color_type& color, const int8u* covers)
		{
			...
			int8u components[3] = { color.b, color.g, color.r };

			int8u* p = m_buffer->row_ptr(y) + x + x / 3;
...
#endif // AGG_PIXFMT_LCD_BGRA_INCLUDED
