...
// PickShapeState
class RectangleToolState::PickShapeState : public DragStateViewState::DragState {
public:
	PickShapeState(RectangleToolState* parent)
		: DragState(parent)
		, fParent(parent)
		, fShape(NULL)
	{
...
// SelectPointsState
class RectangleToolState::SelectPointsState : public DragStateViewState::DragState {
public:
	SelectPointsState(RectangleToolState* parent)
		: DragState(parent)
		, fParent(parent)
		, fPathPoint()
	{
...
// DragPathPointState
class RectangleToolState::DragPathPointState : public DragStateViewState::DragState {
public:
	DragPathPointState(RectangleToolState* parent)
		: DragState(parent)
		, fParent(parent)
		, fPathPoint()
...
// DragSelectionState
class RectangleToolState::DragSelectionState : public DragStateViewState::DragState {
public:
	DragSelectionState(RectangleToolState* parent)
		: DragState(parent)
		, fParent(parent)
	{
	}
...
class RectangleToolState::ToggleSmoothSharpState
	: public DragStateViewState::DragState {
public:
	ToggleSmoothSharpState(RectangleToolState* parent)
		: DragState(parent)
		, fParent(parent)
		, fPathPoint()
		, fDragMode(DRAG_MODE_NONE)
...
// AddPathPointState
class RectangleToolState::AddPathPointState : public DragStateViewState::DragState {
public:
	AddPathPointState(RectangleToolState* parent)
		: DragState(parent)
		, fParent(parent)
		, fPathRef()
		, fPointAdded(false)
...
class RectangleToolState::InsertPathPointState
	: public DragStateViewState::DragState {
public:
	InsertPathPointState(RectangleToolState* parent)
		: DragState(parent)
		, fParent(parent)
		, fPathRef()
		, fPointAdded(false)
...
class RectangleToolState::RemovePathPointState
	: public DragStateViewState::DragState {
public:
	RemovePathPointState(RectangleToolState* parent)
		: DragState(parent)
		, fParent(parent)
		, fPathPoint()
	{
...
// ClosePathState
class RectangleToolState::ClosePathState : public DragStateViewState::DragState {
public:
	ClosePathState(RectangleToolState* parent)
		: DragState(parent)
		, fParent(parent)
	{
	}
...
// CreateShapeState
class RectangleToolState::CreateShapeState : public DragStateViewState::DragState {
public:
	CreateShapeState(RectangleToolState* parent)
		: DragState(parent)
		, fParent(parent)
	{
	}
...
// PointAdded
void
RectangleToolState::PointAdded(const Path* path, int32 index)
{
...
// PointRemoved
void
RectangleToolState::PointRemoved(const Path* path, int32 index)
{
...
// PointChanged
void
RectangleToolState::PointChanged(const Path* path, int32 index)
{
	ObjectChanged(path);
}
...
// PathChanged
void
RectangleToolState::PathChanged(const Path* path)
{
	ObjectChanged(path);
}
...
// PathClosedChanged
void
RectangleToolState::PathClosedChanged(const Path* path)
{
	ObjectChanged(path);
}
...
// PathReversed
void
RectangleToolState::PathReversed(const Path* path)
{
...
// CreateShape
bool
RectangleToolState::CreateShape(BPoint canvasLocation)
{
	if (fInsertionLayer == NULL) {
	...
	if (shape == NULL || style == NULL) {
		fprintf(stderr, "RectangleToolState::CreateShape(): Failed to allocate "
	...
	if (!fInsertionLayer->AddObject(shape, fInsertionIndex)) {
		fprintf(stderr, "RectangleToolState::CreateShape(): Failed to add "
...
// CreatePath
bool
RectangleToolState::CreatePath(BPoint canvasLocation)
{
	Path* path = new(std::nothrow) Path();
	if (path == NULL) {
		fprintf(stderr, "RectangleToolState::CreatePath(): Failed to allocate "
			"Path. Out of memory\n");
		return false;
	}
	...
	if (!path->AddPoint(canvasLocation)) {
		fprintf(stderr, "RectangleToolState::CreatePath(): Failed to add "
...
// SetShape
void
RectangleToolState::SetShape(Shape* shape, bool modifySelection)
{
	if (fShape == shape)
		return;
...
// 	_SetHoverPoint
void
RectangleToolState::_SetHoverPoint(const PathPoint& point) const
{
...
// _SetSelectionRect
void
RectangleToolState::_SetSelectionRect(const BRect& rect,
...
// _SelectPoint
void
RectangleToolState::_SelectPoint(const RectangleToolState::PathPoint& point, bool extend)
{
	if (!extend)
		_DeselectPoints();
...
// _DeselectPoint
void
RectangleToolState::_DeselectPoint(const RectangleToolState::PathPoint& point)
{
...
// _DeselectPoints
void
RectangleToolState::_DeselectPoints()
{
